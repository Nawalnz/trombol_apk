...
import 'package:testing/screens/contactus.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  final List<Widget> _pages = [
    Center(child: Text('Page 1', style: TextStyle(fontSize: 24, color: Colors.white))),
    Center(child: Text('Page 2', style: TextStyle(fontSize: 24, color: Colors.white))),
  ];
                ...
                Spacer(),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        // TODO: Add navigation or logic for Explore Beach
                      },
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        // TODO: Add navigation or logic for Log In
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xFF085373),
                        shape: RoundedRectangleBorder(

...
class _Onboarding1State extends State<Onboarding1> {
  ...
  final List<Widget> _pages = [
    Center(child: Text('First onboarding page', style: TextStyle(fontSize: 24, color: Colors.white))),
    Center(child: Text('Second onboarding page', style: TextStyle(fontSize: 24, color: Colors.whitone))),
  ];

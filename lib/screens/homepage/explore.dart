...
class ExploreTodayContent extends StatelessWidget {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: [
                            _buildCategoryButton(Icons.hotel, "Accommodations"),
                            _buildCategoryButton(Icons.flight, "Attractions"),
                            _buildCategoryButton(Icons.directions, "Travelling"),
                          ],
                        ),
                      ),
                    ],
  ...
  static Widget _buildCategoryButton(IconData icon, String label) {
    return Container(
